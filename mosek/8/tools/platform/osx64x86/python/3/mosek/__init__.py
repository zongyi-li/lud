...
class Task:
    ...
    def getaslice(self,accmode_,first_,last_,ptrb,ptre,sub,val): # 3
      ...
      if val_ is not None and len(val_) != (maxnumnz_):
        raise ValueError("Array argument val has wrong length")
      res = self.__obj.getaslice64(accmode_,first_,last_,maxnumnz_,len(_surp),ptrb_,ptre_,sub_,val_)
      if res != 0:
        result,msg = self.__getlasterror(res)
        raise Error(rescode(res),msg)
      if _copyback_val:
    ...
    def getarowslicetrip(self,first_,last_,subi,subj,val): # 3
      ...
      if val_ is not None and len(val_) != (maxnumnz_):
        raise ValueError("Array argument val has wrong length")
      res = self.__obj.getarowslicetrip(first_,last_,maxnumnz_,len(_surp),subi_,subj_,val_)
      if res != 0:
        result,msg = self.__getlasterror(res)
        raise Error(rescode(res),msg)
      if _copyback_val:
    ...
    def getacolslicetrip(self,first_,last_,subi,subj,val): # 3
      ...
      if val_ is not None and len(val_) != (maxnumnz_):
        raise ValueError("Array argument val has wrong length")
      res = self.__obj.getacolslicetrip(first_,last_,maxnumnz_,len(_surp),subi_,subj_,val_)
      if res != 0:
        result,msg = self.__getlasterror(res)
        raise Error(rescode(res),msg)
      if _copyback_val:
    ...
    def getqconk(self,k_,qcsubi,qcsubj,qcval): # 3
      ...
      res,resargs = self.__obj.getqconk64(k_,maxnumqcnz_,len(_qcsurp),qcsubi_,qcsubj_,qcval_)
      if res != 0:
        result,msg = self.__getlasterror(res)
        raise Error(rescode(res),msg)
      _numqcnz_return_value = resargs
    ...
    def getqobj(self,qosubi,qosubj,qoval): # 3
      ...
      res,resargs = self.__obj.getqobj64(maxnumqonz_,len(_qosurp),qosubi_,qosubj_,qoval_)
      if res != 0:
        result,msg = self.__getlasterror(res)
        raise Error(rescode(res),msg)
      _numqonz_return_value = resargs
