function [U, W, remainingIndex] =  listreg_autoshift(lossMat, T, mu_new, N, r0, rfinal, S, epsilon, padded_maxiter,quad_maxiter)
...
d = size(lossMat,1) - 1;
r = r0;
[Wh, ~, ~] =  quadratic_autoshift(lossMat, T, r, mu_new, S, quad_maxiter); % first run, zero shift
